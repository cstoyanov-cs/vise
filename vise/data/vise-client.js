...
ρσ_unpack = ρσ_unpack_asarray(2, ρσ_unpack);
    ...
    (function(){
        ...
        current_request = (function(){
            ...
            ρσ_d["id"] = 0;
            ρσ_d["accumulated_keypresses"] = ρσ_list_decorate([]);
            return ρσ_d;
        }).call(this);
        function start_follow_link(action) {
            ...
            current_request.hint_groups = ρσ_list_decorate([]);
            current_request.accumulated_keypresses = ρσ_list_decorate([]);
        ...
        function mark_visible_hints() {
            ...
            var ρσ_Iter0 = enumerate(all_elems);
            ρσ_Iter0 = ((typeof ρσ_Iter0[Symbol.iterator] === "function") ? (ρσ_Iter0 instanceof Map ? ρσ_Iter0.keys() : ρσ_Iter0) : Object.keys(ρσ_Iter0));
            for (var ρσ_Index0 of ρσ_Iter0) {
                ρσ_unpack = ρσ_Index0;
                i = ρσ_unpack[0];
        ...
        function assign_hints() {
            ...
            all_hints = [];
            var ρσ_Iter1 = current_request.hint_groups;
            ρσ_Iter1 = ((typeof ρσ_Iter1[Symbol.iterator] === "function") ? (ρσ_Iter1 instanceof Map ? ρσ_Iter1.keys() : ρσ_Iter1) : Object.keys(ρσ_Iter1));
            for (var ρσ_Index1 of ρσ_Iter1) {
                hg = ρσ_Index1;
            ...
            var ρσ_Iter2 = enumerate(current_request.all_hints);
            ρσ_Iter2 = ((typeof ρσ_Iter2[Symbol.iterator] === "function") ? (ρσ_Iter2 instanceof Map ? ρσ_Iter2.keys() : ρσ_Iter2) : Object.keys(ρσ_Iter2));
            for (var ρσ_Index2 of ρσ_Iter2) {
                ρσ_unpack = ρσ_Index2;
                i = ρσ_unpack[0];
            ...
            var ρσ_Iter4 = current_request.accumulated_keypresses;
        ...
        function update_hint_numbers(hint_map) {
            var newnum, elem;
            var ρσ_Iter5 = document.querySelectorAll("[" + ATTR + "]");
        ...
        function follow_link(text) {
            ...
            hint_groups = Object.create(null);
            all_hints = [];
            var ρσ_Iter6 = enumerate(current_request.all_hints);
